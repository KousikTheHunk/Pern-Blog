...
import { setBlog , clearBlog } from '@/redux/blogSlice'
...
const UpdateBlog = () => {
    ...
    const selectBlog = blog.find(blog => blog.id.toString() === id)
    console.log(selectBlog);

     /* useEffect(() => {
        console.log('redux blog :', blog);
        dispatch(clearBlog());
        console.log('redux blog :', blog);
      }, [blog]); */
    ...
    const togglePublishUnpublish = async (action) => {
        ...
        try {
            const res = await axios.post(`http://localhost:8000/api/v1/blog/${id}`, {
                params: {
                    action
                },
                withCredentials: true
            ...
            <div className='max-w-6xl mx-auto mt-8'>
                <Card className="w-full bg-white dark:bg-gray-800 p-5 space-y-2">
                    ...
                    <div>
                        ...
                        value={blogData.category}               // ← controlled value
                        onValueChange={(value) =>
